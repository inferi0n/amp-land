...
app.post('/login', setHeaders, (req, res) => {
    ...
    user.save().then(() => {
        ...
        if (err.code && err.code === 11000) {
            ...
            return res.send("<h2>Приносим свои извинения</h2><p>Произошла ошибка, пожалуйста попробуйте позднее, или перезвоните по бесплатному номеру</p><p><a href='+71234567890' title='Бесплатный звонок'>+7 (123) 456-78-90</a></p> <p>Cообщите об ошибке и приобретайте наши товары со <b>скидкой 15%</b>.</p>")
        }
    });
});
